...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      <div className="fixed inset-0 -z-10 w-screen h-screen bg-gradient-to-br from-slate-950 via-purple-950 via-rose-950/40 to-slate-900">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(88,28,135,0.2),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(190,24,93,0.2),transparent_40%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(6,78,115,0.2),transparent_40%)]" />
      </div>
